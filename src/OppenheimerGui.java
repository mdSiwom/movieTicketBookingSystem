...
public class OppenheimerGui implements ActionListener {
    ...
    OppenheimerGui(ArrayList<Show> shows1, ArrayList<Theatre> theatres1, ArrayList<Booking> bookings1,
        ...
        JLabel label1 = new JLabel(new ImageIcon("oppen.jpg"));
