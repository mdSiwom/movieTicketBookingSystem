...
public class BarbieGui implements ActionListener {

    JFrame frame = new JFrame("Barbie");
    ...
    BarbieGui(ArrayList<Show> shows1, ArrayList<Theatre> theatres1, ArrayList<Booking> bookings1,
        ...
        JLabel label1 = new JLabel(new ImageIcon("barbie.jpg"));
